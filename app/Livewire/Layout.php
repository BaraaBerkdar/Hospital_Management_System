...
class Layout extends Component
{
    ...
    public function render()
    {
        ...
        ])->layout('livewire.GroupService.empty');
    ...
    {
        $this->resetErrorBag();
        $product = $this->allServices->find($this->GroupsItems[$index]['services_id']);
    ...
    public function saveGroup()
    {
        ...
        if($this->updateMode){
            ...
            foreach ($this->GroupsItems as $GroupsItem) {
                $Groups->hasServices()->attach($GroupsItem['services_id'],['quantity' => $GroupsItem['quantity']]);
            }
    ...
    // public function render()
    // {  
    //     return view('livewire.layout')->layout('livewire.GroupService.empty');
    // }
}
