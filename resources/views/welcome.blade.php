                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        ...
                        <div class="sec-title light">
                            <h2>{{__('website/head.sections')}}</h2>
                            <div class="separator"></div>
                        </div>
                        <!--Tab Btns-->
                        <ul class="tab-btns tab-buttons clearfix">
                            ...
                            <li data-tab="#tab-department" class="tab-btn">{{$section->name }}</li>
    ...
    <section class="testimonial-section-two">
        <div class="auto-container">
            ...
            <div class="sec-title centered">
                <h2> الاطباء المختصين</h2>
                <div class="separator"></div>
            </div>
            <div class="testimonial-carousel owl-carousel owl-theme">
                @foreach ($doctors as $doctor)
                <div class="testimonial-block-two" width="500px">
                ...
                <!-- Tesimonial Block Two -->
                    <div class="inner-box">
                        ...
                        <div class="image">
                            <img src="{{asset('Dashboard/img/doctors/'.$doctor->image->filename)}}" alt=""/>
                        </div>
                        @endif
                            <div class="text">
                               <span>الايام المتواجد فيها الدكتور</span>
                               @foreach($doctor->hasAppointment as $appointment)
                               {{$appointment->name}}-
                                 @endforeach
                            </div>
                        <div class="lower-box">
                            <div class="clearfix">
                                ...
                                <div class="pull-right">
                                    <div class="author-info">
                                        <h3> {{$doctor->name}}</h3>
                                        <div class="author"> {{$doctor->section->name}}</div>
                                    </div>
                                </div>
