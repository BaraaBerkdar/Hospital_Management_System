                                        ...
                                        <div class="tab-pane" id="tab2">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover text-md-nowrap text-center">
                                                    ...
                                                    {{-- @foreach($group_invoices as $invoice)
                                                    <tr>
                                                        <td>{{$loop->iteration}}</td>
                                                        <td>{{ $invoice->Group->name}}</td>
                                                        <td>{{$invoice->invoice_date}}</td>
                                                ...
                                                <table class="table table-hover text-md-nowrap text-center" id="example1">
                                                        ...
                                                        @endif
                                                            ...
                                                            <td>
                                                                ...
                                                                فاتورة 
                                                                    ...
                                                                    {{$Patient_account->hasInvoice->Service->name ?? $Patient_account->hasInvoice->Group->name }}



                                                                @elseif($Patient_account->receipt_id == true)
                                                                    {{$Patient_account->hasReceipt->description}}

                                                                @elseif($Patient_account->Payment_id == true)
                                                                    {{$Patient_account->hasPyment->description}}
                                                                @endif
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="alert alert-danger">
                                                            <span class="text-danger"> {{$Debit - $credit}}   {{ $Debit-$credit > 0 ? 'عليك' :'لك'}}</span>                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
