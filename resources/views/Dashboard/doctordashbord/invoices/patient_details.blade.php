                                                        ...
                                                        <tr>
                                                           ...
                                                           {{-- <td>{{$patient_ray->employee->name ?? 'noEmployee'}}</td> --}}
                                                            ...
                                                            @if($patient_ray->doctor_id == auth()->user()->id)
                                                                ...
                                                                @else
                                                                    <td>
                                                                        <a class="modal-effect btn btn-sm btn-warning"  href="{{route('ray.show',$patient_ray->id)}}"><i class="fas fa-binoculars"></i></a>
                                                                    </td>

                                                                @endif
                                                            @endif
                                                        </tr>
                                                        @include('Dashboard.doctordashbord.invoices.deleted')
                                                        @include('Dashboard.doctordashbord.invoices.edit_xray_conversion')
                                                    @endforeach
                                                    </tbody>
                                                </table>
                                            </div>
                                                    ...
                                                    @foreach($patient_Laboratories as $patient_Laboratorie)
                                                        <tr>
                                                            ...
                                                            @if($patient_Laboratorie->doctor_id == auth()->user()->id)
                                                                ...
                                                                @else
                                                                    <td>
                                                                        <a class="modal-effect btn btn-sm btn-warning"  href="{{route('lab.show',$patient_Laboratorie->id)}}"><i class="fas fa-binoculars"></i></a>
                                                                    </td>
                                                        ...
                                                        @include('Dashboard.doctordashbord.invoices.edit_laboratorie_conversion')
                                                        @include('Dashboard.doctordashbord.invoices.deleted_laboratorie')
                                                    @endforeach
                                                    </tbody>
                                                </table>
                                            </div>
