                                    ...
                                    <div class="table-responsive">
                                        <table class="table text-md-nowrap" id="example1">
                                           ...
                                           @foreach($invoices as $invoice)
                                               ...
                                               @include('Dashboard.doctordashbord.invoices.add_diagnosis')
                                               @include('Dashboard.doctordashbord.invoices.add_review')
                                               @include('Dashboard.doctordashbord.invoices.xray_conversion')
                                                     
                                               @include('Dashboard.doctordashbord.invoices.Laboratorie_conversion')
                                           @endforeach
                                            </tbody>
                                        </table>
                                    </div>
