...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div>
						  <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">لوحة التحكم للدكتور</h2>
				...
				<div class="row row-sm">
					<div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-primary-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-4 tx-12 text-white"> عدد الفواتير </h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h2 class="tx-20 font-weight-bold mb-1 text-white">{{App\Models\Single_invoice::where('doctor_id',Auth::user()->id)->count()}}</h2>

											{{-- <p class="mb-0 tx-10 text-white op-7">Compared to last week</p> --}}
					...
					<div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-danger-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-4 tx-12 text-white">عدد الفواتير المكتملة  </h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
					...
					<div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-success-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-4 tx-12 text-white"> عدد الفوانير الغير مكتملة   </h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
