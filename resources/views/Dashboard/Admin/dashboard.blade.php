...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div>
						  <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">  {{__('Dashboard/title.Admin')}} </h2>
					...
					<div class="main-dashboard-header-right">
						...
						<div>
							<label class="tx-13"> {{__('Dashboard/title.services')}}   </label>
							<h5>{{$services}}</h5>
						</div>
						<div>
							<label class="tx-13"> {{__('Dashboard/title.group_services')}}   </label>
							<h5>{{$groupservice}}</h5>
						</div>
					</div>
				</div>
				...
				<div class="row row-sm">
					<div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-primary-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white"> {{__('Dashboard/title.doctor_number')}} </h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{$doctor}}</h4>
					...
					<div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-danger-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">{{__('Dashboard/title.pation_number')}}   </h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{$patient}}</h4>
					...
					<div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-success-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">  {{__('Dashboard/title.section_number')}} </h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
