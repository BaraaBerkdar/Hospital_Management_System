                ...
                <div class="dropdown nav-item main-header-notification">
                    ...
                    <div class="dropdown-menu dropdown-notifications">
                        <div class="menu-header-content bg-primary text-right">
                            ...
                            <p data-count="{{App\Models\Notifacation::GetNotifacation()->count()}}" class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 notif-count">{{App\Models\Notifacation::GetNotifacation()->count()}}</p>
                        </div>
                        <div class="main-notification-list Notification-scroll">

                            <div class="new_message">
                            <a class="d-flex p-3 border-bottom" href="route('doctor.invoice')">
                            ...
                            @foreach(App\Models\Notifacation::GetNotifacation()->get() as $notification )
                            <a class="d-flex p-3 border-bottom" href="{{ route('read',$notification->id)}}">
                                <div class="notifyimg bg-pink">
                                    <i class="la la-file-alt text-white"></i>
                                </div>
                                <div class="mr-3">
                        ...
                        <div class="dropdown-footer">
                            <a href="{{route('read_all')}}">VIEW ALL</a>
                        </div>
                    </div>
                </div>
...
<script src="http://localhost/laravel-10-breeze/resources/js/app.js" ></script>
...
<script>
    ...
    channel.bind('my-event', function(data) {
       ...
       <h4 class="notification-label mb-1">`+data.message+data.pation+`</h4>
