			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            <li><a class="slide-item" href="{{route('doctor.invoice')}}">قائمة الكشوفات</a></li>
                            <li><a class="slide-item" href="{{route('doctor.invoice_complet')}}">قائمة الكشوفات المكتملة</a></li>
                            <li><a class="slide-item" href="{{route("doctor.reviewinvoice")}}">قائمة المراجعات</a></li>
						</ul>
					</li>
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
                            <li><a class="slide-item" href="{{route('pation.list')}}">قائمة المرضي</a></li>
                            <li><a class="slide-item" href="{{route('pationchat.list')}}">المحادثات الاخيرة</a></li>
                        </ul>
                    </li>
				</ul>
			</div>
