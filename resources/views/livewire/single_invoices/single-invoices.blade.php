                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped mg-b-0 text-md-nowrap" style="text-align: center">
                                        ...
                                        <tr>
                                            ...
                                            <td><input wire:model="discount_value" type="text" class="form-control" wire:change="get_price"></td>
                                            <th><input wire:model="tax_rate" type="text" class="form-control"  wire:change="get_price"></th>
