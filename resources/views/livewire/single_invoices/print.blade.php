...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <a href="{{route('Invoices.single')}}"><h4 class="content-title mb-0 my-auto">الفواتير</h4></a><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ طباعه الفواتير</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
