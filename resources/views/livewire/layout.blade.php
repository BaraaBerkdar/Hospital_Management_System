                                    ...
                                    <tr>
                                        <td>
                                            @if($groupItem['is_saved'])
                                                <input type="hidden" name="GroupsItems[{{$index}}][services_id]"
                                                       wire:model="GroupsItems.{{$index}}.services_id"/>
                                            ...
                                            <select name="GroupsItems[{{$index}}][services_id]"
                                                ...
                                                @foreach ($allServices as $service)
                                                    <option value="{{ $service->id }}">
                                                        ...
                                                        {{ \App\Models\ServicesTranslation::where(['services_id' => $service->id])->pluck('name')->first() }}
